...
/***/ function(module, exports, __webpack_require__) {
	...
	const react_redux_1 = __webpack_require__(25);
	const App_1 = __webpack_require__(34);
	const reducers_1 = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const MainSection_1 = __webpack_require__(38);
	const actions_1 = __webpack_require__(42);
	const App = ({ todos, actions }) => (React.createElement("div", null,
	    React.createElement(Header_1.default, { addTodo: actions.addTodo }),
	    React.createElement(MainSection_1.default, { todos: todos, actions: actions })));
	const mapStateToProps = (state) => ({
	    todos: state.todos
	});
	const mapDispatchToProps = (dispatch) => ({
	    actions: redux_1.bindActionCreators(actions_1.TodoActions, dispatch)
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const React = __webpack_require__(1);
	const TodoTextInput_1 = __webpack_require__(36);
	class Header extends React.Component {
	    ...
	    render() {
	        return (React.createElement("header", { className: "header" },
	            ...
	            React.createElement(TodoTextInput_1.TodoTextInput, { newTodo: true, onSave: this.handleSave, placeholder: "What needs to be done?" })));
	    }
	}
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const React = __webpack_require__(1);
	const classnames = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const React = __webpack_require__(1);
	const TodoItem_1 = __webpack_require__(39);
	const Footer_1 = __webpack_require__(40);
	const TodoFilters_1 = __webpack_require__(41);
	const TODO_FILTERS = {
	    [TodoFilters_1.SHOW_ALL]: () => true,
	    [TodoFilters_1.SHOW_ACTIVE]: (todo) => !todo.completed,
	    [TodoFilters_1.SHOW_COMPLETED]: (todo) => todo.completed
	};
	class MainSection extends React.Component {
	    constructor(props) {
	        ...
	        this.state = { filter: TodoFilters_1.SHOW_ALL };
	    }
	    ...
	    renderFooter(completedCount) {
	        ...
	        if (todos.length) {
	            return (React.createElement(Footer_1.Footer, { completedCount: completedCount, activeCount: activeCount, filter: filter, onClearCompleted: this.handleClearCompleted, onShow: this.handleShow }));
	        }
	        else
	            return null;
	    }
	    render() {
	        ...
	        return (React.createElement("section", { className: "main" },
	            ...
	            React.createElement("ul", { className: "todo-list" }, filteredTodos.map(todo => React.createElement(TodoItem_1.TodoItem, __assign({ key: todo.id, todo: todo }, actions)))),
	...
	class TodoItem extends React.Component {
	    ...
	    render() {
	        ...
	        if (this.state.editing) {
	            element = (React.createElement(TodoTextInput_1.TodoTextInput, { text: todo.text, editing: this.state.editing, onSave: (text) => this.handleSave(todo.id, text) }));
	        }
	        else {
	            element = (React.createElement("div", { className: "view" },
	                React.createElement("input", { className: "toggle", type: "checkbox", checked: todo.completed, onChange: () => completeTodo(todo.id) }),
	                React.createElement("label", { onDoubleClick: this.handleDoubleClick }, todo.text),
	                React.createElement("button", { className: "destroy", onClick: () => deleteTodo(todo.id) })));
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	const TodoFilters_1 = __webpack_require__(41);
	const FILTER_TITLES = {
	    [TodoFilters_1.SHOW_ALL]: "All",
	    [TodoFilters_1.SHOW_ACTIVE]: "Active",
	    [TodoFilters_1.SHOW_COMPLETED]: "Completed"
	};
	class Footer extends React.Component {
	    ...
	    renderFilterLink(filter) {
	        ...
	        return (React.createElement("a", { className: classnames({ selected: filter === selectedFilter }), style: { cursor: "pointer" }, onClick: () => onShow(filter) }, title));
	    }
	    renderClearButton() {
	    ...
	    render() {
	        return (React.createElement("footer", { className: "footer" },
	            ...
	            React.createElement("ul", { className: "filters" }, [TodoFilters_1.SHOW_ALL, TodoFilters_1.SHOW_ACTIVE, TodoFilters_1.SHOW_COMPLETED].map(filter => React.createElement("li", { key: filter }, this.renderFilterLink(filter)))),
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const types = __webpack_require__(43);
	exports.TodoActions = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const redux_1 = __webpack_require__(3);
	const todos_1 = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const ActionTypes_1 = __webpack_require__(43);
	const initialState = [
	    {
	        text: "Use Redux",
	        completed: false,
	...
	function todos(state = initialState, action) {
	    switch (action.type) {
	        ...
	        case ActionTypes_1.EDIT_TODO:
	            return state.map(todo => todo.id === action.id ? __assign({}, todo, { text: action.text }) :
	                todo);
	        case ActionTypes_1.COMPLETE_TODO:
	            return state.map(todo => todo.id === action.id ? __assign({}, todo, { completed: !todo.completed }) :
	                todo);
	        case ActionTypes_1.COMPLETE_ALL:
	            const areAllMarked = state.every(todo => todo.completed);
	            return state.map(todo => (__assign({}, todo, { completed: !areAllMarked })));
